...
export const envConfig = {
  ...
  plugins: [
    ...
    new DefinePlugin({
      ...
      "process.env.REACT_APP_MODE": JSON.stringify("testing"),
      ...
      "process.env.REACT_APP_API_URL": JSON.stringify("https://test-api.muvr.io/api"),
      "process.env.REACT_APP_API_IMAGE_URL": JSON.stringify("https://test-api.muvr.io/public/"),
      "process.env.REACT_APP_SOCKET_URL": JSON.stringify("https://test-api.muvr.io/"),
